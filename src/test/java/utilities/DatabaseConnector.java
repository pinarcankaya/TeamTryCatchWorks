...
public class DatabaseConnector {
    ...
    private static final String dbusername = utilities.ConfigurationReader.getProperty("myusername");
    private static final String dbpassword = utilities.ConfigurationReader.getProperty("mypassword");
    private static final String connectionUrl =utilities.ConfigurationReader.getProperty("myUrl");
